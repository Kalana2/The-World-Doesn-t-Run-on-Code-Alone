...
This research proposal aims to presents passenger behavior and boarding decisions at mentioned bus stops. This will helps to optimize bus schedules at peak and off peak times on passenger behavior.  As a result of that we can present many solutions to existing problems such as reducing the number of waiting passengers at the peak hours.
...
This research study looks at how passengers behave while waiting at bus stops considering peak hours, weak  conditions etc. The aim is to investigate how passengers behave make boarding decisions, focusing on common behaviours.
...
\item How to waiting times affect decisions and actions of passengers?

\item Why do some passengers reject crowded buses?
...
\item High Number of passengers in bus stop

\item Buses arrive frequently because these bus stops are located on highly busy area

\item More number of passengers in peak hours
...
Our research observations identified several common passenger activities such as:

\begin{itemize}[noitemsep]

\item Waiting for specific buses
...
\item Talking with other passengers
