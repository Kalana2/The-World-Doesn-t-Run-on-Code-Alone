...
This chapter summarises the research proposal, highlights the expected contributions of the
study, and identifies areas for future investigation related to passenger behaviour and public
transportation systems.

\section{Summary of the Proposed Research}

This proposal presents a plan to investigate passenger waiting behaviour and boarding
decisions at three urban bus stops in Colombo—Reid Avenue, Town Hall, and Fort Main. The
study will employ a mixed-method design involving direct observation, informal interviews,
surveys, passenger counting, and waiting-time measurement during both peak and off-peak
hours.

The research will specifically examine:

\begin{itemize}[noitemsep]
    \item Passenger waiting behaviour and patterns;
    \item Boarding and rejection decisions;
    \item Crowd-related behavioural dynamics;
    \item Differences between bus stop environments; and
    \item The influence of waiting conditions on passenger actions.
\end{itemize}

By combining behavioural observations with quantitative data, the research aims to provide
a nuanced understanding of how passengers respond to varying transport conditions in urban
...
\begin{itemize}[noitemsep]
    \item Identify common passenger waiting behaviours;
    \item Explain factors that cause extended waiting times;
    \item Analyse how crowd density shapes passenger decisions;
    \item Compare passenger behaviour across different bus stops; and
    \item Determine passenger reactions to overcrowded buses and service delays.
\end{itemize}

The findings may also explain how passengers balance comfort, urgency, safety, and
convenience when making transport decisions. Practically, the research may support better
passenger management strategies, improved queue organisation at bus stops, deeper
understanding of commuter experiences in crowded environments, and future transportation
planning.

\section{Future Improvements and Extensions}

This study can serve as a foundation for several extensions. Future research could:

\begin{itemize}[noitemsep]
    \item Include a greater number of bus stops from different regions of Sri Lanka;
    \item Compare passenger behaviour in rural and urban transport environments;
    \item Investigate seasonal or weather-related behavioural changes;
    \item Analyse the impact of digital transport information systems on passenger decisions; and
    \item Examine behavioural differences among distinct demographic groups.
\end{itemize}

Future work could also apply advanced statistical methods, larger survey samples, or
extended observation periods to enhance accuracy and reliability. The scope may be
broadened to encompass related phenomena such as queue discipline, commuter stress,
route selection, and passenger safety behaviour in public transportation systems.

% ────────────────────────────────────────────────────────────
%  REFERENCES  (no section numbering)
% ────────────────────────────────────────────────────────────
\setcounter{secnumdepth}{-1}
...
\begingroup
\renewcommand{\chapter}[2]{}   % suppress biblio heading (we have our own)
\bibliographystyle{agsm}       % Harvard-compatible style
\begin{thebibliography}{9}

\bibitem[Bryman, 2016]{bryman2016}
Bryman, A. (2016) \textit{Social Research Methods}. 5th edn. Oxford: Oxford University Press.

\bibitem[Creswell, 2014]{creswell2014}
Creswell, J.W. (2014) \textit{Research Design: Qualitative, Quantitative and Mixed Methods Approaches}. 4th edn. Thousand Oaks, CA: SAGE Publications.

\bibitem[Tashakkori and Teddlie, 2010]{tashakkori2010}
Tashakkori, A. and Teddlie, C. (eds.) (2010) \textit{SAGE Handbook of Mixed Methods in Social and Behavioral Research}. 2nd edn. Thousand Oaks, CA: SAGE Publications.
